...
<head>
    ...
    <title>Register for Recording Construction Induction</title>
</head>
@php
$ctr = 1;
@endphp
            ...
            <div class="pdf-wrapper proximanova-regular">
                    ...
                    <div>
                        <table width="100%">
                            <tr>
                                ...
                                <td width="50%">
                                    <p class="primary-font-color px-16-font text-right line-height-1point2 europa-bold">REGISTER FOR RECORDING CONSTRUCTION INDUCTION</p>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="pdf-wrapper pdf-body">
                    <table width="100%" class="green-bordered-table">
                        <tbody>
                            <tr>
                                <td class="text-center primary-bg-color" colspan="6"><span
                                        class="europa-bold white-font-color">REGISTER FOR RECORDING CONSTRUCTION INDUCTION</span></td>
                                <td class="text-center primary-bg-color" colspan="4"><span
                            ...
                            <tr class="px-10-font">
                                ...
                                <td class="text-center primary-bg-color" width="10%"><span
                                        class="europa-bold white-font-color">DATE OF BIRTH</span> </td>
                                <td class="text-center primary-bg-color" width="10%"><span
                                        class="europa-bold white-font-color">CODE OF UNIT OF COMPETENCY</span> </td>
                                <td class="text-center primary-bg-color" width="18%"><span class="europa-bold white-font-color">NAME OF UNIT OF COMPETENCY
                                    </span> </td>
                                ...
                                <td class="text-center primary-bg-color" width="8%"><span class="europa-bold white-font-color">DATE
                                        ISSUED</span> </td>
                                <td class="text-center primary-bg-color" width="8%"><span class="europa-bold white-font-color">Date of the SOA sent to student</span> </td>
                                <td class="text-center primary-bg-color" width="8%"><span class="europa-bold white-font-color">CEA representative initials</span> </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td valign="top">{{ $scl['dob'] }}</td>
                                <td valign="top">{{ $scl['unit_code'] }}</td>
                                <td valign="top">{{ $scl['unit_description'] }}</td>
                                <td valign="top">{{ $scl['soa_no'] }}</td>
                                <td valign="top">{{ $scl['soa_date_issued'] }}</td>
                                <td valign="top">{{ $scl['soa_date_created'] }}</td>
                                <td valign="top"></td>
                            </tr>
                            @php $ctr++ @endphp
                            @endforeach
                    ...
                    <tr>
                        <td>
                            <div class="footer bottom-placement px-10-font text-center primary-font-color">
                                <p style="margin-bottom: 2px;">© VORX RTO | Register for Recording Construction Induction</p>
                            ...
                            <tr>
                                ...
                                <td width="50%">
                                    <p class="primary-font-color px-16-font text-right line-height-1point2 europa-bold">
                                        REGISTER FOR RECORDING CONSTRUCTION INDUCTION</p>
                                </td>
                            </tr>
                        </table>
                    </div>
