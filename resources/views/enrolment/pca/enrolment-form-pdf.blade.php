						...
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td width="60%" valign="top" style="padding-left: 10px;">
									...
									{{-- @if(isset($ef['course']) && $ef['course']['code'] == 'CPP20218')
										<div class="checkbox {{isset($ef['course']) && $ef['course']['code'] == 'CPP20218' ? 'checked' : ''}}"" style="margin-bottom: 0;">
											<label class="label label-checkbox black-font-color" style="font-family:'ProximaNova-Bold'!important;"> CPP20218 – Certificate II in Security Operations</label>
											<br>
											<label class="px-12-font" style="line-height: 12px; margin-left: 69px;"> (CRICOS Course Code: 102919D, Duration: 8 Weeks)</label>
											<div class="clearfix" style="height: 30px;"></div>
											@if(isset($ef['course']) && $ef['course']['code'] == 'CPP20218')
												<p class="proximanova-bold px-12-font m-0">Course Description:</p>
												<a href="https://training.gov.au/Training/Details/CPP20218" class="px-12-font">https://training.gov.au/Training/Details/CPP20218</a>
											@endif
										</div>
									@elseif(isset($ef['course']) && $ef['course']['code'] == 'CPC31320')
										<div class="checkbox {{isset($ef['course']) && $ef['course']['code'] == 'CPC31320' ? 'checked' : ''}}"" style="margin-bottom: 0;">
											<label class="label label-checkbox black-font-color" style="font-family:'ProximaNova-Bold'!important;"> CPC31320 – Certificate III in Wall and Floor Tiling</label>
											<br>
											<label class="px-12-font" style="line-height: 12px; margin-left: 69px;"> (CRICOS Course Code: 104663G, Duration: 96 Weeks)</label>
											<div class="clearfix" style="height: 30px;"></div>
											@if(isset($ef['course']) && $ef['course']['code'] == 'CPC31320')
												<p class="proximanova-bold px-12-font m-0">Course Description:</p>
												<a href="https://training.gov.au/Training/Details/CPC31320" class="px-12-font">https://training.gov.au/Training/Details/CPC31320</a>
											@endif
										</div>
									@endif --}}
								</td>
										...
										<tr>
											...
											<td width="15%" valign="middle">
												...
												@else
													...
													<p class="px-14-font proximanova-bold text-right ml-seventy" style="line-height: 14px;"> Mobile<img src="{{public_path()}}/custom/pca-enrolment/images/arrow.png" style="margin-left: 2px;"></p>
												@endif
												<!-- <p class="px-14-font proximanova-bold text-right" style="line-height: 14px;"> Mobile<img src="{{public_path()}}/custom/pca-enrolment/images/arrow.png" style="margin-left: 2px;"></p> -->
											</td>
											<td width="45%" valign="middle" style="padding-left: 10px;">
								...
								<td width="20%" valign="middle" colspan="2">
									<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-left: 125px;">
										<tr>
											...
											<td width="36%" valign="middle" style="padding-left: 10px;">
												<div class="textbox display-inlineblock" style="width: 145px; margin-top: 5px; margin-bottom: 5px;"></div>
											</td>
										</tr>
									</table>
								</td>
								...
								<td width="20%" valign="middle">
									<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-left: 125px;">
										<tr>
											...
											<td width="42%" valign="middle" style="padding-left: 10px;">
												<div class="textbox display-inlineblock" style="width: 149px; margin-top: 5px; margin-bottom: 5px;">{{isset($ef['passport_no']) ? $ef['passport_no'] : null}}</div>
											</td>
										</tr>
									</table>
								</td>
			...
			<div class="pdf-wrapper">
				...
				<div style="padding-bottom: 10px;  margin: 0 30px;">
					...
					<div class="content" style="position: relative; width: 100%; height: 140px;">
						...
						<span class="proximanova-bold text-right" style="transform: rotate(-90deg); position: absolute; top: 40px; left: 30px; line-height: 14px;">OVERSEAS<br>STUDENT HEALTH<br>COVER (OSHC)</span>
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="20%" valign="middle" colspan="2">
									<table width="95%" cellpadding="0" cellspacing="0" border="0" style="margin-left: 125px;">
										<tr>
											<td width="20%" valign="top">
												<p class="px-13-font proximanova-bold text-right" style="line-height: 14px;"> Overseas Student<br>Health Cover<img src="{{public_path()}}/custom/pca-enrolment/images/arrow.png" style="margin-left: 2px;"></p>
											</td>
											<td width="80%" valign="top" style="padding-left: 10px;">
												<p class="px-14-font proximanova-bold display-inlineblock" style="line-height: 14px;"> Have you got OSHC?</p>
												<table width="60%" cellpadding="0" cellspacing="0" border="0" style=" margin-left: 150px; margin-top: -18px;">
													<tr>
														<td width="50%">
															<div class="checkbox {{isset($ef['oshc_flag']) && $ef['oshc_flag'] == true ? 'checked' : ''}}"><label class="label label-checkbox"> Yes</label></div>
														</td>
														<td width="50%">
															<div class="checkbox {{isset($ef['oshc_flag']) && $ef['oshc_flag'] != true ? 'checked' : ''}}"><label class="label label-checkbox"> No</label></div>
														</td>
													</tr>
												</table>
											</td>
										...
										<tr>
											<td width="20%" valign="top"></td>
											<td width="80%" valign="top" style="padding-left: 10px;">
												<p class="px-14-font proximanova-bold display-inlineblock" style="line-height: 14px;"> Type of OSHC?</p>
												<table width="80%" cellpadding="0" cellspacing="0" border="0" style=" margin-left: 120px; margin-top: -18px;">
													<tr>
														<td width="50%">
															<div class="checkbox {{isset($ef['oshc_type']) && $ef['oshc_type'] == 'Single' ? 'checked' : ''}}"><label class="label label-checkbox"> Single</label></div>
														</td>
														<td width="50%">
															<div class="checkbox {{isset($ef['oshc_type']) && $ef['oshc_type'] == 'Couple' ? 'checked' : ''}}"><label class="label label-checkbox"> Couple</label></div>
														</td>
														<td width="50%">
															<div class="checkbox {{isset($ef['oshc_type']) && $ef['oshc_type'] == 'Family' ? 'checked' : ''}}"><label class="label label-checkbox"> Family</label></div>
														</td>
													</tr>
												</table>
												<div class="clearfix" style="height: 15px;"></div>
												<p class="px-14-font" style="line-height: 14px;">Please refer to OSHC providers such as but not limited to: <a href="https://www.nib.com.au/overseas-students">https://www.nib.com.au/overseas-students</a></p>
											</td>
										</tr>
									</table>
								</td>
		...
		<div class="col-xs-12 no-padding">
			<div class="pdf-wrapper">
				...
				<div style="padding-bottom: 10px;  margin: 0 30px;">
					...
					<div class="content" style="position: relative; width: 100%; height: 640px;">
						<!-- #20 -->
						<span class="px-60-font line-height-1" style="margin-left: 20px; position: absolute; top: 0; left: -20px;">20</span>
													...
													<tr>
														<td width="100%" colspan="3">
															<ul class="list">
																...
																<li class="px-14-font">Entry Requirements for International Students Policy and procedure</li>
			...
			<div class="pdf-wrapper">
				...
				<div style="padding-bottom: 10px;  margin: 0 30px;">
					...
					<div class="content" style="position: relative; width: 100%;">
						...
						<div class="clearfix" style="height: 10px;"></div>
						<p class="px-12-font text-justify" style="line-height: 12px;">Please be advised that the information collected from the students as part of the enrolment will be provided to the Department of Home Affairs, other State/Territory government agencies, the Tuition Protection Scheme (TPS) and the ESOS Assurance Fund Manager in relation to administering the ESOS Act 2000 and the Migration Act 1958.</p>
						<div class="clearfix" style="height: 10px;"></div>
