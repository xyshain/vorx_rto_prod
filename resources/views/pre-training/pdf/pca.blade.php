                    ...
                    <tbody>
                        ...
                        <tr>
                            <td valign="top" colspan="2" height="200px">
                                ...
                                <p>If yes, please specify:</p>
                                <p style="height:60px;">
                                {{isset($ptr->inputs->relevant_comp_spec)?$ptr->inputs->relevant_comp_spec:''}}
                                </p>
                                <p class="px-14-font proximanova-bold">
                        ...
                        <tr>
                            <td valign="top" colspan="2">
                                ...
                                <p style="height:100px;">
                                    {{isset($ptr->inputs->why_choose_spec)?$ptr->inputs->why_choose_spec:''}}
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" colspan="2">
                                ...
                                <p style="height:100px;">
                                    {{isset($ptr->inputs->support_service_spec)?$ptr->inputs->support_service_spec:''}}
                                </p>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table width="91%" class="form-table table-bordered" cellpadding="0" cellspacing="0" border="0" style="word-wrap:break-word">
                    ...
                    <tr>
                            <td valign="top" colspan="2">
                                ...
                                <p>
                                    {{isset($ptr->inputs->role_play_spec)?$ptr->inputs->role_play_spec:''}}
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" colspan="2">
                                ...
                                <p>
                                @if(isset($ptr->inputs->course_outcomes_awareness))
                        ...
                        <tr>
                            <td valign="top" colspan="2">
                                ...
                                <p>
                                @if(isset($ptr->inputs->skills_req_awareness))
                        ...
                        <tr>
                            <td valign="top" colspan="2">
                                ...
                                <p>
                                @if(isset($ptr->inputs->ct_awareness))
                        ...
                        <tr>
                            <td valign="top" colspan="2">
                                ...
                                <p>
                                @if(isset($ptr->inputs->prev_attainments))
                                ...
                                <p>
                                    {{isset($ptr->inputs->prev_attainments_spec)?$ptr->inputs->prev_attainments_spec:''}}
                                </p>
                                <p class="px-14-font proximanova-bold" style="line-height: 12px;"><span class="proximanova">As applicable, consider and document:</span></p>
                        ...
                        <tr>    
                            <td valign="top" colspan="2">
                                ...
                                <p>
                                @if(isset($ptr->inputs->currently_working))
                                ...
                                <p>Position/title:<u>{{isset($ptr->inputs->currently_working_spec)?$ptr->inputs->currently_working_spec:''}}</u></p>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td v-align="top" colspan="2">
                                ...
                                <p>
                                    {{isset($ptr->inputs->learning_styles_spec)?$ptr->inputs->learning_styles_spec:''}}
                                </p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td v-align="top" colspan="2">
                                ...
                                <p>
                                    {{isset($ptr->inputs->add_support_spec)?$ptr->inputs->add_support_spec:''}}
                                </p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td valign="top" width="30%" class="proximanova" style="padding: 2px 5px;" colspan="2">
                                <p class="px-14-font proximanova">
                                <p>
                                @if(isset($ptr->inputs->ncver_participate_awareness))
                        ...
                        <tr>
                            <td valign="top" width="30%" class="proximanova" style="padding: 2px 5px;" colspan="2">
                                <p class="px-14-font proximanova">
                                <p>
                                @if(isset($ptr->inputs->fees_awareness))
                        ...
                        <tr>
                            <td valign="top" width="30%" class="proximanova" style="padding: 2px 5px;" colspan="2">
                                <p class="px-14-font proximanova">
                                <p>
                                    @if(isset($ptr->inputs->complaints_and_appeals))
                        ...
                        <tr>
                            <td valign="top" width="30%" class="proximanova" style="padding: 2px 5px;" colspan="2">
                                <p class="px-14-font proximanova">
                                <p>
                                @if(isset($ptr->inputs->attendance_requirements))
			...
			<div class="pdf-wrapper">
                ...
                <table width="91%" class="form-table table-bordered" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td valign="top" width="30%" class="peach-bg-color proximanova-bold" style="padding: 2px 5px;" colspan="2">
                            <p class="px-14-font proximanova-bold">
                            Signature: <u><span class="type-signature">{{isset($ptr->inputs->student_signature)?$ptr->inputs->student_signature:''}}</span></u>
                            </p>
                        </td>
                    </tr>
                    <tr>
