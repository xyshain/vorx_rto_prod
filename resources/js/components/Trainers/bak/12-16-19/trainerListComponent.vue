<template>
    <div class="app-modal">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <v-client-table :data="trainerList" :columns="columns" :options="options" ref="trainerTable">
                        ...
                        <div class="btn-group" slot="commission_setting" slot-scope="{row}">
                            <a href="javascript:void(0)" class="btn btn-primary btn-sm" @click="commissionSetting(row.id)"> <i class="fas fa-user-cog"></i></a>
                        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                // Vue-Tables-2 Syntax
                columns:['id','name', 'phone_number','email','course_taught','course_location','commission_setting','actions'],
                options: {
                    initialPage:1,
                    perPage:10,
