<template lang="">
    <modal name="size-modal-edit" transition="nice-modal-fade" classes="demo-modal-class" :min-width="200" :min-height="200" :pivot-y="0.1" :adaptive="true" :scrollable="true" :reset="true" width="60%" height="auto" @before-open="beforeOpen" @opened="opened" @closed="closed" @before-close="beforeClose">
        <div class="size-modal-content">
            ...
            <form @submit.prevent>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <multiselect v-model="comset.course_codes" tag-placeholder="" placeholder="Select Course" label="name" track-by="code" :options="slct_course_codes" :multiple="true" :taggable="true" @tag="addTag">
                            </multiselect>
                    ...
                    <div class="col-lg-6">
                        <div :class="['form-group', errors.commission_type_id ? 'has-error' : '']">
                            ...
                            <multiselect v-model="comset.commission_type_id" tag-placeholder="" placeholder="Select Mode Symbol" label="type" track-by="type" :options="slct_com_type" :multiple="false" :taggable="true" @tag="addTag">
                            </multiselect>
                ...
                <button class="btn btn-success float-right" @click="saveChanges"><i class="far fa-save"></i> Save Changes</button>
            </form>
...
<script>
    export default {
        data() {
            ...
            methods: {
                saveChanges() {
                        axios.post(`/trainer/commission-settings/${this.trainer_id}/update/${this.comset_id}`, {
                                id: this.comset.id,
                            ...
                            .then(res => {
                                if (res.data.status == 'updated') {
                                    ...
                                    this.$modal.hide('size-modal-edit');
                                } else {
                                    Toast.fire({
                                        type: 'error',
