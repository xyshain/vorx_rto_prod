        ...
        >
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="oh_tuition_individual">Tuition fees for individual course:</label>
                  <input
                    type="number"
                    min="0"
                    class="form-control"
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="oh_tuition_package">Tuition fees when packaged:</label>
                  <input
                    type="number"
                    min="0"
                    class="form-control"
                    name="onshore_tuition_package"
                    id="onshore_tuition_package"
                    v-model="field.onshore_tuition_package"
                  />
                  <div
                    v-if="errors[index] && errors[index].onshore_tuition_package"
                    class="badge badge-danger"
                  >{{ errors[index].onshore_tuition_package[0] }}</div>
                </div>
              </div>
            </div>
            <div v-bind:class="'horizontal-line-wrapper-'+app_color+' mb-2'">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="os_tuition_individual">Tuition fees for individual course:</label>
                  <input
                    type="number"
                    min="0"
                    class="form-control"
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="os_tuition_package">Tuition fees when packaged:</label>
                  <input
                    type="number"
                    min="0"
                    class="form-control"
                    name="offshore_tuition_package"
                    id="offshore_tuition_package"
                    v-model="field.offshore_tuition_package"
                  />
                  <div
                    v-if="errors[index] && errors[index].offshore_tuition_package"
                    class="badge badge-danger"
                  >{{ errors[index].offshore_tuition_package[0] }}</div>
                </div>
              </div>
            </div>
          </div>
