...
export default {
    ...
    created(){
        ...
        if(typeof window.email_warning != 'undefined' && window.email_warning != null){
            console.log(window.email_warning.config);
            this.automation = window.email_warning.config;
            this.emails = window.email_warning.emails;
        }
