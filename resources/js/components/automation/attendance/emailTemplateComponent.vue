            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="custom-control custom-switch my-2">
                        <input type="checkbox" class="custom-control-input" id="active1" v-model="fields.active" value="0">
                        <label class="custom-control-label" for="active1">Set as Active</label>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        fetchTemplates() {
            axios.get('/warning-letter/attendance/template/fetch').then(response => {
        ...
        saveCreateUpdate() {
            axios({
                method: 'put',
                url: '/warning-letter/attendance/template/store',
                data: this.fields,
            }).then(response => {
