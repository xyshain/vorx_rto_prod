...
export default {
    ...
    created(){
        ...
        if(typeof window.email_warning_attendance != 'undefined' && window.email_warning_attendance != null){
            console.log(window.email_warning_attendance.config);
            this.automation = window.email_warning_attendance.config;
            this.emails = window.email_warning_attendance.emails;
        }
