            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="custom-control custom-switch my-2">
                        <input type="checkbox" class="custom-control-input" id="activez" v-model="fields.active" value="0">
                        <label class="custom-control-label" for="activez">Set as Active</label>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        saveCreateUpdate() {
            axios.post('/pdplan/templates/save',
                this.fields
            ).then(
                response=>{
        ...
        edit(row) {
            ...
            this.fields.email_content = row.email_content;
            this.fields.email_module_id = row.email_module_id;
            this.fields.email_subject = row.email_subject;
            this.fields.active = row.active;
        },
        remove(id) {
            swal.fire({
                title: 'Are you sure?',
