        ...
        <div class="card border-0 shadow-lg ">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <span class="font-weight-bold h4 m-0 float-right"> Education Agent Agreement</span>
            ...
            <div class="card-body p-0">
                <div>
                    <div class="row px-4 pt-4">
                        <span class="font-weight-bold h5 m-0"> Education Agent Agreement & Signature for <span :class="'text-'+this.app_color">{{student_name}}</span></span>
                        <div :class="'horizontal-line-wrapper-'+app_color+' mb-2 col-md-12 '">
                            <h6>Please review the following List </h6>
                            </div>
                        <div class="col-md-12">
                             <label for=""> <a :href="`/agent-agreement/preview/${process_id}`" target="_blank"> Education Agent Agreement - View  <i class="fas fa-eye"> </i></a> </label>
                        </div>
                        <!-- <div :class="'horizontal-line-wrapper-'+app_color+' mb-2 col-md-12 '">
...
export default {
    ...
    created() {
        this.student_name = typeof window.agent_app !== 'undefined' ? window.agent_app.agent_name : null;
        this.process_id = typeof window.agent_app !== 'undefined' ? window.agent_app.process_id : null;
    },
    methods: {
        undo() {
        ...
        save_form(){
            ...
            if(this.sig_acceptance_agreement == true && this.type_signature != ''){
                axios.post('/agent-agreement/review',data).then(res=>{
