                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="logo-wrapper position-relative">
                            <img :src="logo_url" alt="profile" :width="default_logo_size">
                        </div>
                    </div>
                    <div class="col-md-8">
                        ...
                        <span class="float-right" style="font-size:12px;">RTO No: {{ app_settings.training_organisation_id }} | Unit Of Competency</span>
                    </div>
                </div>
            </div>
                                    ...
                                    <div v-for="(content, key_content) in itm['content']" :key="key_content">
                                        ...
                                        <div v-if="content.type == 'signature'">
                                            <div class="col-md-12 no-padding">
                                                    <div class="form-group">
                                                        <p class="text-justify"><input type="checkbox" v-model="sig_acceptance_agreement" class=""  style="width: 35px;height: 20px;"><span>Electronic Transactions (Queensland) Act 2001 establishes the regulatory framework for transactions to be completed electronically. This form requires you to tick the boxes and put your name as an electronic signature before submission. By ticking the box and putting the name in signature panel, you indicate your approval of the contents of this electronic form.</span></p>
                                                    </div>
                                                </div>
                                            <div class="col-md-12 no-padding">
                                                <div class="form-group">
...
export default {
    ...
    created() {
        ...
        // ------
        this.default_logo_size = typeof window.app_settings !== 'undefined' && window.app_settings.training_organisation_id == '6074' ? '110px' : '170px';
    },
    methods: {
        toType(obj) {
        ...
        saveChanges() {
                ...
                for (let vr in vm.required){
                    ...
                    if( notAllowed.indexOf(vm.inputs[vr]) != -1){
                ...
                if (inputs.question5_a != null) {
                    if(inputs.question5_a != 'undefined'){
                        inputs.question5_a = moment(inputs.question5_a).format("YYYY-MM-DD");
                    }
                }else{
                    inputs.question5_a = null;
                }
                 if (inputs.question5_b != null) {
                    if(inputs.question5_b != 'undefined'){
                        inputs.question5_b = moment(inputs.question5_b).format("YYYY-MM-DD");
                    }
                }else{
                    inputs.question5_b = null;
                }
            ...
            swal.fire({
                ...
                if (result.value) {
                    ...
                    axios.post('/unit-of-competency/lln-test/submit', data)
                    .then(res => {
                        // console.log(res);
