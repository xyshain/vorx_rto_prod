                ...
                <div>
                    ...
                    <div class="row p-3">
                        <div class="col-lg-6 col-md-6 col-sm-6 text-left">
                            <button class="btn btn-danger" v-if="toType(pages[cur_page - 1]) !== 'undefined'" @click="change_page(cur_page - 1)"><i class="fas fa-arrow-circle-left"></i> Back</button>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 text-right">
                            <button class="btn btn-danger" v-if="toType(pages[cur_page  + 1]) !== 'undefined'" @click="change_page(cur_page + 1)">Next <i class="fas fa-arrow-circle-right"></i></button>
    ...
    methods: {
        ...
        submitCode(e){
            ...
            if(vm.access_code !== " " && vm.access_code !== null){
                ...
                axios({
                    method: 'get',
                    url: `/pca/online-lln-test/find/${vm.access_code}`,
                }).then(response => {
        ...
        saveChanges() {
            ...
            swal.fire({
                ...
                if (result.value) {
                    ...
                    axios.post('/pca/online-lln-test/submit', data)
                    .then(res => {
                        // console.log(res);
