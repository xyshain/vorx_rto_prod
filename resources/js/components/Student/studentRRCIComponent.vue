<template>
    <div>
      ...
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Register for Recording Construction Induction</h6>
      </div>
      <div class="card-body">
        <!-- <div class="table-responsive"> -->
          ...
          <table :class="'table table-bordered header-'+app_color" id="dataTable" width="100%" cellspacing="0">
            <thead>
              <tr>
                <th :class="'text-center table-header-'+app_color" colspan="5">Register for Recording Construction Induction</th>
                ...
                <th :class="'text-center table-header-'+app_color" colspan="4">Statement of Attainment</th>
              </tr>
              <tr>
                ...
                <th :class="'text-center table-header-'+app_color">Date of Birth</th>
                <th :class="'text-center table-header-'+app_color">Code of Unit of Competency</th>
                <th :class="'text-center table-header-'+app_color">Name of Unit of Competency</th>
                ...
                <th :class="'text-center table-header-'+app_color">Date Issued</th>
                <th :class="'text-center table-header-'+app_color">Date of the SOA sent to student</th>
                <th :class="'text-center table-header-'+app_color">CEA representative initials</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="(qir, item) in newList" v-bind:key="item+1">
                ...
                <td class="text-center">{{ qir.dob }}</td>
                
                <td class="text-center">{{ qir.unit_code }}</td>
                <td class="text-center">{{ qir.unit_description }}</td>
                ...
                <td class="text-center">{{ qir.soa_date_created }}</td>
...
<script>
    export default {
        ...
        methods: {
            fetchData(page_url) {
              let vm = this;
              page_url = page_url || 'rrci-soa/info';
              fetch(page_url)
                .then(res => res.json())
                .then(res => {
                  vm.qirList = res.data;
            ...
            if (vm.searchQIR.length != 'undefined' && vm.searchQIR.length > 3) {
              fetch(`/rrci-soa/search/${vm.searchQIR}`)
                .then(res => res.json())
                .then(res => {
          ...
          generate_qir(){
            ...
            window.open(`/rrci-soa/generate/${str}`, '_blank');
            },
        }
    }
</script>
