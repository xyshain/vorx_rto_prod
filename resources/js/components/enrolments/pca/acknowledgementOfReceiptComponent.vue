        ...
        <div class="card border-0 shadow-lg ">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <span class="font-weight-bold h4 m-0 float-right"> Acknowledgement of receipt of Student Handbook and Pre-enrolment information</span>
            ...
            <div class="card-body p-0">
                <div>
                    ...
                    <!-- navigation -->
                    <div class="row p-3">
                        <div class="col-lg-12" v-if="toType(pages[cur_page  + 1]) === 'undefined'">
...
export default {
    ...
    methods: {
        ...
        saveForm () {
            ...
            swal.fire({
            title: 'Submit Acknowledgement Form?',
            ...
            if (result.value) {
                ...
                swal.fire({
                    title: 'Submitting Acknowledgement Form...',
                ...
                axios.post('/pca/acknowledgement-of-receipt/save',data)
                .then(function(res){
                    // console.log(res);
