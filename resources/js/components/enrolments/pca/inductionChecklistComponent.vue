        ...
        <div class="card border-0 shadow-lg ">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <span class="font-weight-bold h4 m-0 float-right"> Student Induction Checklist (International Students)</span>
...
export default {
    ...
    methods: {
        ...
        saveForm () {
            ...
            swal.fire({
            title: 'Submit Induction Checklist?',
            ...
            if (result.value) {
                ...
                swal.fire({
                    title: 'Submitting Induction Checklist...',
                ...
                axios.post('/pca/induction-checklist/save',data)
                .then(function(res){
                    // console.log(res);
