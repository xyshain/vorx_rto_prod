...
class OnlineLLNTestPCAController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('lln-test.pca.online.index');
    }
    ...
    public function pages($process_id = null) 
    {
        ...
        if($process_id != null) {
            ...
            $lln_form = Storage::get('/public/enrolment/' . $ep->process_id . '/online-lln-form.txt');
        ...
        // dd($lln_val);
        $ACSF_performance_table_text = url("custom/pca-lln-test-form/images/lln/ACSF-performance-table-text.png");
        $q1_worksafe_img = url("custom/pca-lln-test-form/images/lln/q1-worksafe-img.jpg");
        $q2_worksafe_img = url("custom/pca-lln-test-form/images/lln/q2-worksafe-img.jpg");
        $partb_q5_c = url("custom/pca-lln-test-form/images/lln/partb-q5-c.jpg");
        $partb_q6 = url("custom/pca-lln-test-form/images/lln/partb-q6.jpg"); 
                            ...
                            [
                                ...
                                'content' => [
                                    [
                                        ...
                                        <h1 class="proximanova-bold text-danger px-14-font text-justify"><span>Why assess core LLN skill levels?</span></h1>
                                        ...
                                        <h1 class="proximanova-bold text-danger px-14-font text-justify"><span>The assessment tasks</span></h1>
                                        ...
                                        <table width="100%" class="table default-bordered-table no-margin px-14-font">
                                            <thead>
                                                <tr>
                                                    <th class="background-danger px-14-font white-font-color text-center th-bg" width="25%">Assessment task</th>
                                                    <th class="background-danger px-14-font white-font-color text-center th-bg" width="35%">ACSF skill and level coverage</th>
                                                    <th class="background-danger px-14-font white-font-color text-center th-bg" width="40%">Description</th>
                                                </tr>
                                                <tr>
                                                    <th class="background-danger px-14-font white-font-color text-center th-bg" colspan="3">Part A</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th class="background-danger px-14-font white-font-color text-center" colspan="3">Part B</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                        ...
                                        <h1 class="proximanova-bold text-danger px-14-font text-justify"><span>Coverage of tasks</span></h1>
                                        ...
                                        <h1 class="proximanova-bold text-danger px-14-font text-justify"><span>ACSF skills and levels covered by assessment tasks </span></h1>
                                        <table width="100%" class="table default-bordered-table">
                                            <thead>
                                                <tr>
                                                    <th class="background-danger proximanova-bold px-14-font white-font-color text-center" width="15%">ACSF Level</th>
                                                    <th class="background-danger proximanova-bold px-14-font white-font-color text-center" width="15%">Learning</th>
                                                    <th class="background-danger proximanova-bold px-14-font white-font-color text-center" width="15%">Reading</th>
                                                    <th class="background-danger proximanova-bold px-14-font white-font-color text-center" width="15%">Writing</th>
                                                    <th class="background-danger proximanova-bold px-14-font white-font-color text-center" width="15%">Oral communication</th>
                                                    <th class="background-danger proximanova-bold px-14-font white-font-color text-center" width="15%">Numeracy</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td width="15%" class="text-center proximanova-bold">4</td>
                                                    <td width="15%" valign="top"></td>
                                                    <td width="15%" valign="top"></td>
                                                    <td width="15%" valign="top">Part B - Task 1: Q.3</td>
                                                    <td width="15%" valign="top">Part B - Task 1: Q.3</td>
                                                    <td width="15%" valign="top"></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="text-center proximanova-bold">1</td>
                                                    <td>Part A</td>
                                                    <td></td>
                                                    <td></td>
                                                    <td>Part A</td>
                                        ...
                                        <h1 class="proximanova-bold text-danger px-14-font text-justify"><span>Mapping of levels and indicators</span></h1>
                                        ...
                                        <div class="clearfix" style="height: 10px;"></div>
                                        <h1 class="proximanova-bold text-danger px-14-font 
                                        ...
                                        <table width="100%" class="default-bordered-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th colspan="4" class="background-danger proximanova-bold  px-14-font text-center">ACSF Performance</th>
                                                </tr>
                                                <tr>
                                                    <th width="22.5%" class="background-danger proximanova-bold  px-14-font text-center padding-y-10"><span>SUPPORT</span></th>
                                                    <th width="22.5%" class="background-danger proximanova-bold  px-14-font text-center padding-y-10"><span>CONTEXT</span></th>
                                                    <th width="22.5%" class="background-danger proximanova-bold  px-14-font text-center padding-y-10"><span>TEXT COMPLEXITY</span></th>
                                                    <th width="22.5%" class="background-danger proximanova-bold  px-14-font text-center padding-y-10"><span>TASK COMPLEXITY</span></th>
                                                </tr>
                                            </thead>
                                        ...
                                        <div class="clearfix" style="height: 10px;"></div>
                                        <h1 class="proximanova-bold text-danger px-14-font text-justify"><span>Steps in the assessment process</span></h1>
                            ...
                            [
                                ...
                                'content' => [
                                    [
                                        ...
                                        <h1 class="proximanova-bold text-danger px-14-font text-justify"><span>1.0 WELCOME</span></h1>
                                        <p class="px-14-font text-justify line-height-1point2">Welcome to the Phoenix College of Australia (PCA).</p>
                                        <div class="clearfix" style="height: 10px;"></div>
                                        <p class="px-14-font text-justify line-height-1point2">Before you are able to commence your course, you must successfully complete the LLN Test. Please note that if you are enrolled in more than one course with PCA, you will only need to complete the LLN Test once.</p>
                                        
                    
                                        <h1 class="proximanova-bold text-danger px-14-font text-justify"><span>2.0 ENTRY REQUIREMENTS</span></h1>
                                        <p class="px-14-font text-justify line-height-1point2">All students are required to undertake a Language Literacy and Numeracy (LLN) test prior to commencement of training.  Outcomes from this test will be used by PCA to develop support strategies for students’ enrolment.  It will also help PCA to decide whether or not it is able to provide required support services or referral to external agencies is required.</p>
                                        <div class="clearfix" style="height: 10px;"></div>
                                        <p class="px-14-font text-justify line-height-1point2">PCA requires ACSF level 3 in CPP20218 - Certificate II in Security Operations.</p>
                    
                    
                    
                                        <h1 class="proximanova-bold text-danger px-14-font text-justify"><span>3.0 LLN TEST</span></h1>
                                        ...
                                        <h1 class="proximanova-bold text-danger px-14-font text-justify"><span>4.0 STARTING THE LLN TEST</span></h1>
                                        <p class="px-14-font text-justify line-height-1point2">This test will be conducted under the supervision of PCA staff.</p>
                    
                                        <h1 class="proximanova-bold text-danger px-14-font text-justify"><span>5.0 COMMENCEMENT OF TRAINING</span></h1>
                                        ...
                                        <h1 class="proximanova-bold text-danger px-14-font text-justify"><span>6.0 SUPPORT SERVICES</span></h1>
                                        <p class="px-14-font text-justify line-height-1point2">PCA recognises the importance of adequate skills in English. LLN improving literacy skills will assist in ensuring education is available to all. LLN test has been designed to describe variations in arrangements for our clients who have specific language, literacy and numeracy needs and the support services available to these persons. Students with special needs in the areas of Language, Literacy and Numeracy will have access to assistance and support to fulfil their training needs.</p>
                                        <div class="clearfix" style="height: 10px;"></div>
                    
                                        <p class="px-14-font text-justify line-height-1point2">PCA endeavours to equip the participant to undertake the tasks of the profession. The Training Department will consult with the Trainers and Assessors to analyse necessary requirements to meet the participant’s individual needs. Where these needs cannot be met, a refund will be given to the participant.</p>
                                        <div class="clearfix" style="height: 10px;"></div>
                    
                                        <p class="px-14-font text-justify line-height-1point2">Where support needs to go beyond what can be met with reasonable adjustment during the training and assessment process, and additional support is required, PCA will direct participants to an external literacy specialist.</p>',
                                    ],
                                ],
                                'col_size' => 12
                            ],
                            ...
                            [
                                ...
                                'content' => [
                                    [
                                        ...
                                        <div class="clearfix" style="height: 10px;"></div>
                                        <p class="px-14-font text-justify line-height-1point2">PCA respects your privacy and will not pass on your personal details to other organisations except as required by law.</p> 
                                        <br>
                                        <br>',
                                    ],
                                ],
                        ...
                        'inputs' => [
                            [
                                ...
                                'content' => [
                                    [
                                        'type' => 'paragraph',
                                        'body' => '<h1 class="proximanova-bold text-danger px-14-font text-justify"><span>Assessor Instructions:</span></h1>
                                        <ul class="px-14-font text-justify no-margin paragraph-list">
                                    ...
                                    [
                                        'type' => 'paragraph',
                                        'body' => '<h1 class="proximanova-bold text-danger px-14-font text-justify"><span>Training goals:</span></h1>',
                                    ]
                                ],
                                'col_size' => 12
                            ],
                        ...
                        'inputs' => [
                            ...
                            [
                                ...
                                'content' => [
                                    [
                                        'type' => 'paragraph',
                                        'body' => '<h1 class="proximanova-bold text-danger px-14-font text-justify"><span><b>Educational background</b></span></h1> ',
                                    ]
                                ]
                            ],
                            [
                            ...
                            [
                                ...
                                'content' => [
                                    [
                                        'type' => 'paragraph',
                                        'body' => '<h1 class="proximanova-bold text-danger px-14-font text-justify"><span><b>Employment</b></span></h1>  ',
                                    ]
                                ]
                            ],
                            [
                        ...
                        'inputs' => [
                            [
                                ...
                                'content' => [
                                    [
                                        'type' => 'paragraph',
                                        'body' => '<h1 class="proximanova-bold text-danger px-14-font text-justify"><span>Student instructions:</span></h1>
                                        <ul class="px-14-font text-justify no-margin paragraph-list">
                                ...
                                'content' => [
                                    [
                                        ...
                                        width: 60%!important;">
                                            <thead>
                                                <tr>
                                                    <th class="background-danger proximanova-bold px-14-font white-font-color text-center" width="50%">Month </th>
                                                    <th class="background-danger proximanova-bold px-14-font white-font-color text-center" width="50%">Average price/litre</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
    ...
    public function llntest_submit(Request $request){
        ...
        // dump($request['process_id']);
        // dd($inputs);
        if($request['process_id'] == null){
            $save = new EnrolmentPack;
            $save->process_id = $this->codeNumber();
            $save->student_name = $inputs['candidate_name'];
            $save->lln = json_encode($request->inputs);
            $save->save();
            // save pages .txt file
            $path = '/public/enrolment/' . $save->process_id . '/online-lln-form.txt';
            Storage::put($path, $request->pages);

            // save pdf file
            $enroll_pack = EnrolmentPack::where('process_id', $save->process_id)->first();
            $pdf_path = storage_path('app/public/enrolment/'.$save->process_id);
            if($enroll_pack){
                $lln = json_decode($enroll_pack->lln, true);
                $partb_q5_c_dataImage = $lln['partb_q5_c_dataImage'];
                $lln_test = $lln['inputs'];
                ...
                \PDF::loadView('lln-test.pca.online.pca-lln-test-pdf', compact('lln_test','student_signature','partb_q5_c_dataImage','logo_url'))->setPaper(array(0, 0, 612, 936), 'portrait')->save($pdf_path.'/online-lln-form.pdf')->stream('online-lln-form');  

                // send email to admin
                $send = $this->send_lln($pdf_path.'/online-lln-form.pdf', $enroll_pack);
    ...
    public function show($process_id)
    {
        ...
        $lln_form = $enroll_pack->lln; 
        $lln_form = json_decode($lln_form, true);
        $personal_details = [];
        $dob = null;
    ...
    public function edit($process_id)
    {
        $app_setting = TrainingOrganisation::first();
        $enroll_pack = EnrolmentPack::where('process_id', $process_id)->first();
        $lln_inputs = json_decode($enroll_pack->lln, true);
         \JavaScript::put([
            'logo_url'              => $this->get_logo(),
            'pages'                 => $this->pages($process_id),
            'lln_inputs'            => $enroll_pack->lln != null ? $lln_inputs['inputs'] : [],
            'partb_q5_c_dataImage'  => $lln_inputs['partb_q5_c_dataImage'] != null ? $lln_inputs['partb_q5_c_dataImage'] : null,
            'process_id'            => $process_id,
            'app_settings'          => $app_setting,
            'type_signature'            => $lln_inputs['type_signature'],
            'sig_acceptance_agreement'  => $lln_inputs['sig_acceptance_agreement'],
            'edit'              => true
        ]);
    ...
    public function assessor($process_id)
    {
        $app_setting = TrainingOrganisation::first();
        $enroll_pack = EnrolmentPack::where('process_id', $process_id)->first();
        $lln_inputs = json_decode($enroll_pack->lln, true);
    ...
    public function lln_preview($process_id){
        ...
        $path = storage_path() . '/app/public/enrolment/'.$process_id . '/online-lln-form.pdf';
        if(file_exists($path)){
             // raw file contents
            ...
            $logo_url = $this->get_logo();
             ...
             return \PDF::loadView('lln-test.pca.online.pca-lln-test-pdf', compact('lln_test','student_signature','partb_q5_c_dataImage','logo_url'))->setPaper(array(0, 0, 612, 936), 'portrait')->stream($file_name);
        }
    }
    ...
    public function student_attachment($student_id){
        ...
        $file_path = '';
        $pdf_file = null;
        $enroll_pack = EnrolmentPack::where('student_id', $student_id)->first();
        if(!$enroll_pack){
            abort(404);
        }
        $lln = json_decode($enroll_pack->lln, true);
        ...
        try {
            ...
            $hashFileName = 'lln-test';
            $pdf_file = \PDF::loadView('lln-test.pca.online.pca-lln-test-pdf', compact('lln_test','enroll_pack', 'student_signature','partb_q5_c_dataImage','logo_url'))->setPaper(array(0, 0, 612, 936), 'portrait')->save($file_path.'/'. $hashFileName . '.pdf');

            $pdf = Storage::size('/public/student/new/attachments/' . $student_id . '/' . $hashFileName . '.pdf');
            $file = StudentAttachment::where('student_id', $student_id)->where('_input', 'lln-test')->first();
            if($file == null){
    ...
    public function send_lln($pdf_path, $ep)
    {
        // SEND LLN
        $org = TrainingOrganisation::first();
        $send = new EmailSendingController;
        $email = EmailAutomation::where('addOn', 'lln')->pluck('email');
        $admin_emails = [];
        ...
        $content = 'Dear Admin,<br><br> Mr./Ms. <b>'. $ep->student_name .''."'".'s</b> LLN Test is now available. Please check email attachment.';
        $s = $send->send_automate('Online LLN Test', $content, [$org->training_organisation_name => $org->email_address], $email, $paths, $admin_emails);
    ...
    public function findCode($process_id){
        if($process_id){
            $ep = EnrolmentPack::where('student_name', null)->where('enrolment_form', null)->where('lln', null)->where('status', 'lln_test')->where('process_id', $process_id)->first();
            if($ep != null){
                if($ep->lln != null || $ep->enrolment_form != null){
                    // access code is used
                    return ['status' => 'error', 'data' => $ep]; 
                }else{
