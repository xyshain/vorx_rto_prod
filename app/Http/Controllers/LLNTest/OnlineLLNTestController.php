...
class OnlineLLNTestController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('lln-test.online-lln-test');
    }
                                ...
                                'content' => [
                                    [
                                        ...
                                        <table width="100%" class="table default-bordered-table no-margin px-14-font">
                                            <thead>
                                                <tr>
                                                    <th class="background-blue px-14-font white-font-color text-center th-bg" width="25%">Assessment task</th>
                                                    <th class="background-blue px-14-font white-font-color text-center th-bg" width="35%">ACSF skill and level coverage</th>
                                                    <th class="background-blue px-14-font white-font-color text-center th-bg" width="40%">Description</th>
                                                </tr>
                                                <tr>
                                                    <th class="background-blue px-14-font white-font-color text-center th-bg" colspan="3">Part A</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th class="background-blue px-14-font white-font-color text-center" colspan="3">Part B</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                        ...
                                        <table width="100%" class="table default-bordered-table">
                                            <thead>
                                                <tr>
                                                    <th class="background-blue proximanova-bold px-14-font white-font-color text-center" width="15%">ACSF Level</th>
                                                    <th class="background-blue proximanova-bold px-14-font white-font-color text-center" width="15%">Learning</th>
                                                    <th class="background-blue proximanova-bold px-14-font white-font-color text-center" width="15%">Reading</th>
                                                    <th class="background-blue proximanova-bold px-14-font white-font-color text-center" width="15%">Writing</th>
                                                    <th class="background-blue proximanova-bold px-14-font white-font-color text-center" width="15%">Oral communication</th>
                                                    <th class="background-blue proximanova-bold px-14-font white-font-color text-center" width="15%">Numeracy</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                        ...
                                        <table width="100%" class="default-bordered-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th colspan="4" class="background-blue proximanova-bold  px-14-font text-center">ACSF Performance</th>
                                                </tr>
                                                <tr>
                                                    <th width="22.5%" class="background-blue proximanova-bold  px-14-font text-center padding-y-10"><span>SUPPORT</span></th>
                                                    <th width="22.5%" class="background-blue proximanova-bold  px-14-font text-center padding-y-10"><span>CONTEXT</span></th>
                                                    <th width="22.5%" class="background-blue proximanova-bold  px-14-font text-center padding-y-10"><span>TEXT COMPLEXITY</span></th>
                                                    <th width="22.5%" class="background-blue proximanova-bold  px-14-font text-center padding-y-10"><span>TASK COMPLEXITY</span></th>
                                                </tr>
                                            </thead>
                            ...
                            [
                                ...
                                'content' => [
                                    [
                                        ...
                                        <p class="px-14-font text-justify line-height-1point2">This test will be conducted under the supervision of CEA staff.</p>
                                ...
                                'content' => [
                                    [
                                        ...
                                        width: 60%!important;">
                                            <thead>
                                                <tr>
                                                    <th class="background-blue proximanova-bold px-14-font white-font-color text-center" width="50%">Month </th>
                                                    <th class="background-blue proximanova-bold px-14-font white-font-color text-center" width="50%">Average price/litre</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
    ...
    public function llntest_submit(Request $request){
        ...
        if($request['process_id'] == null){
            ...
            if($enroll_pack){
                ...
                \PDF::loadView('lln-test.online-lln-test-pdf', compact('lln_test','student_signature','partb_q5_c_dataImage','logo_url'))->setPaper(array(0, 0, 612, 936), 'portrait')->save($pdf_path.'/online-lln-form.pdf')->stream('online-lln-form');  
    ...
    public function lln_preview($process_id){
        ...
        if(file_exists($path)){
            ...
            $logo_url = $this->get_logo();
             ...
             return \PDF::loadView('lln-test.online-lln-test-pdf', compact('lln_test','student_signature','partb_q5_c_dataImage','logo_url'))->setPaper(array(0, 0, 612, 936), 'portrait')->stream($file_name);
        }
    }
    ...
    public function student_attachment($student_id){
        ...
        try {
            ...
            $pdf_file = \PDF::loadView('lln-test.online-lln-test-pdf', compact('lln_test','enroll_pack', 'student_signature','partb_q5_c_dataImage','logo_url'))->setPaper(array(0, 0, 612, 936), 'portrait')->save($file_path.'/'. $hashFileName . '.pdf');
    ...
    public function send_lln($pdf_path, $ep)
    {
        ...
        $admin_emails = ['admissions@communityeducation.edu.au'];
